...
const messages = {
  ...
  'apiDocs.allMethods': { 'zh-CN': '全部方法', 'en-US': 'All methods' },
  'apiDocs.allTags': { 'zh-CN': '全部分组', 'en-US': 'All tags' },
  'apiDocs.auth': { 'zh-CN': '认证', 'en-US': 'Auth' },
  'apiDocs.authHiddenHint': {
    'zh-CN': '未登录隐藏 API 存在性。',
    'en-US': 'Unauthenticated access hides API existence.',
  },
  'apiDocs.basePath': { 'zh-CN': '基础路径', 'en-US': 'Base path' },
  'apiDocs.basePathHint': {
    'zh-CN': '显示当前运行时 webBasePath 下的完整 API 前缀。',
    'en-US': 'Shows the full API prefix under the current runtime webBasePath.',
  },
  'apiDocs.copyUrl': { 'zh-CN': '复制 JSON 地址', 'en-US': 'Copy JSON URL' },
  'apiDocs.copied': { 'zh-CN': 'OpenAPI 地址已复制', 'en-US': 'OpenAPI URL copied' },
  'apiDocs.csrf': { 'zh-CN': '写操作 CSRF', 'en-US': 'Write CSRF' },
  'apiDocs.csrfHint': {
    'zh-CN': '非安全方法需要 Session CSRF token。',
    'en-US': 'Unsafe methods require the session CSRF token.',
  },
  'apiDocs.description': {
    'zh-CN': '从当前 Go 后端读取运行时 OpenAPI JSON，按 Vue 面板样式展示可检索的接口契约。',
    'en-US':
      'Read the runtime OpenAPI JSON from the current Go backend and render a searchable Vue panel contract.',
  },
  'apiDocs.downloadJson': { 'zh-CN': '下载 JSON', 'en-US': 'Download JSON' },
  'apiDocs.errorTitle': {
    'zh-CN': '无法加载 OpenAPI 文档',
  ...
  'apiDocs.operations': { 'zh-CN': '个接口', 'en-US': 'operations' },
  'apiDocs.paramDescription': { 'zh-CN': '说明', 'en-US': 'Description' },
  'apiDocs.paramIn': { 'zh-CN': '位置', 'en-US': 'In' },
  'apiDocs.paramName': { 'zh-CN': '名称', 'en-US': 'Name' },
  'apiDocs.paramRequired': { 'zh-CN': '必填', 'en-US': 'Required' },
  'apiDocs.parameters': { 'zh-CN': '参数', 'en-US': 'Parameters' },
  'apiDocs.rawOperation': { 'zh-CN': '原始 Operation JSON', 'en-US': 'Raw operation JSON' },
  'apiDocs.readOnlyDescription': {
    'zh-CN':
      '该页面只读展示本仓库维护的面板 API 契约，不执行接口调用，也不引入 React 或 Swagger UI。',
    'en-US':
      'This page renders the repository-owned panel API contract read-only; it does not execute API calls or import React/Swagger UI.',
  },
  'apiDocs.readOnlyMessage': {
    'zh-CN': '自建 Vue OpenAPI 文档链路',
    'en-US': 'Repository-owned Vue OpenAPI documentation pipeline',
  },
  ...
  'apiDocs.section': { 'zh-CN': '分组', 'en-US': 'Section' },
  'apiDocs.security': { 'zh-CN': '安全要求', 'en-US': 'Security' },
  'apiDocs.serverUrl': { 'zh-CN': '服务地址', 'en-US': 'Server URL' },
  'apiDocs.sessionExpired': {
    'zh-CN': '登录会话已过期，正在跳转到登录页。',
    'en-US': 'The login session expired; redirecting to the login page.',
  },
  'apiDocs.tagFilter': { 'zh-CN': '按接口分组筛选', 'en-US': 'Filter operations by API tag' },
  'apiDocs.title': { 'zh-CN': 'Panel OpenAPI 文档', 'en-US': 'Panel OpenAPI Docs' },
  'apiDocs.unauthenticated': { 'zh-CN': '未登录响应', 'en-US': 'Unauthenticated' },
  'apiDocs.yes': { 'zh-CN': '是', 'en-US': 'Yes' },
  ...
  'nav.docs': { 'zh-CN': 'API 文档', 'en-US': 'API Docs' },
  ...
  'route.docs': { 'zh-CN': 'API 文档', 'en-US': 'API Docs' },
  ...
  'xray.gateway.description': {
    'zh-CN': '生成面向 Gateway 容器登记的 Xray 兼容 SOCKS5 入站与 CSV 清单，不新增后端出口模型。',
    'en-US':
...
export const reviewedDomTranslations = [
  ...
  {
    source: 'Client records stay outside advanced JSON to prevent conflicting edits.',
    zhCN: '客户端记录与高级 JSON 分开管理，避免编辑冲突。',
    enUS: 'Client records stay outside advanced JSON to prevent conflicting edits.',
    context: 'Inbound client editor',
  },
  {
    source:
      'Advanced settings remain editable; client records are protected and managed separately.',
    zhCN: '高级设置仍可编辑；客户端记录受保护并单独管理。',
    enUS: 'Advanced settings remain editable; client records are protected and managed separately.',
    context: 'Advanced JSON editor',
  },
  {
    source: 'Manage clients with the client form instead of Settings JSON',
    zhCN: '请使用客户端表单管理客户端，不要在设置 JSON 中编辑',
    enUS: 'Manage clients with the client form instead of Settings JSON',
    context: 'Inbound validation',
  },
  {
  ...
  },
  {
    ...
    zhCN: 'TUN 设置',
    enUS: 'TUN Settings',
    context: 'TUN settings',
  },
  {
    source:
      'Interface addresses, DNS and routing fields stay synchronized with the current Xray TUN schema.',
    zhCN: '接口地址、DNS 与路由字段会与当前 Xray TUN 结构保持同步。',
    enUS: 'Interface addresses, DNS and routing fields stay synchronized with the current Xray TUN schema.',
    context: 'TUN settings',
  },
  { source: 'MTU', zhCN: 'MTU', enUS: 'MTU', context: 'TUN settings' },
  {
    source: 'Gateway CIDRs',
    zhCN: '网关 CIDR',
    enUS: 'Gateway CIDRs',
    context: 'TUN settings',
  },
  {
    source: 'DNS Addresses',
    zhCN: 'DNS 地址',
    enUS: 'DNS Addresses',
    context: 'TUN settings',
  },
  ...
  {
    source: 'Auto System Route CIDRs',
    zhCN: '自动系统路由 CIDR',
    enUS: 'Auto System Route CIDRs',
    context: 'TUN settings',
  },
  {
    source: 'Outbounds Interface',
    zhCN: '出站接口',
    enUS: 'Outbounds Interface',
    context: 'TUN settings',
  },
  {
    source: 'Padding Obfuscation',
    zhCN: '填充混淆',
    enUS: 'Padding Obfuscation',
    context: 'XHTTP settings',
  },
  { source: 'Padding Key', zhCN: '填充键', enUS: 'Padding Key', context: 'XHTTP settings' },
  {
    source: 'Padding Header',
    zhCN: '填充请求头',
    enUS: 'Padding Header',
    context: 'XHTTP settings',
  },
  {
    source: 'Padding Placement',
    zhCN: '填充位置',
    enUS: 'Padding Placement',
    context: 'XHTTP settings',
  },
  {
  ...
  {
    source: 'Uplink HTTP Method',
    zhCN: '上行 HTTP 方法',
    enUS: 'Uplink HTTP Method',
    context: 'XHTTP settings',
  },
  {
    source: 'Session Placement',
    zhCN: '会话标识位置',
    enUS: 'Session Placement',
    context: 'XHTTP settings',
  },
  { source: 'Session Key', zhCN: '会话键', enUS: 'Session Key', context: 'XHTTP settings' },
  {
    source: 'Sequence Placement',
    zhCN: '序列标识位置',
    enUS: 'Sequence Placement',
    context: 'XHTTP settings',
  },
  {
    source: 'Sequence Key',
  ...
  {
    source: 'Uplink Data Placement',
    zhCN: '上行数据位置',
    enUS: 'Uplink Data Placement',
    context: 'XHTTP settings',
  },
  {
    source: 'Uplink Data Key',
    zhCN: '上行数据键',
    enUS: 'Uplink Data Key',
    context: 'XHTTP settings',
  },
  {
    source: 'Uplink Chunk Size',
    zhCN: '上行分块大小',
    enUS: 'Uplink Chunk Size',
    context: 'XHTTP settings',
  },
  { source: 'XMUX', zhCN: 'XMUX', enUS: 'XMUX', context: 'XHTTP XMUX settings' },
  {
    source: 'XMUX Max Concurrency',
    zhCN: 'XMUX 最大并发数',
    enUS: 'XMUX Max Concurrency',
    context: 'XHTTP XMUX settings',
  },
  {
    source: 'XMUX Max Connections',
    zhCN: 'XMUX 最大连接数',
    enUS: 'XMUX Max Connections',
    context: 'XHTTP XMUX settings',
  },
  {
    source: 'XMUX Max Reuse Times',
    zhCN: 'XMUX 最大复用次数',
    enUS: 'XMUX Max Reuse Times',
    context: 'XHTTP XMUX settings',
  },
  {
    source: 'XMUX Max Request Times',
    zhCN: 'XMUX 最大请求次数',
    enUS: 'XMUX Max Request Times',
    context: 'XHTTP XMUX settings',
  },
  {
    source: 'XMUX Max Reusable Seconds',
    zhCN: 'XMUX 最大可复用秒数',
    enUS: 'XMUX Max Reusable Seconds',
    context: 'XHTTP XMUX settings',
  },
  {
    source: 'XMUX Keep Alive Period',
    zhCN: 'XMUX 保活周期',
    enUS: 'XMUX Keep Alive Period',
    context: 'XHTTP XMUX settings',
  },
  {
    source: 'Inline Certificate',
    zhCN: '内联证书',
    enUS: 'Inline Certificate',
    context: 'TLS settings',
  },
  {
    source: 'Inline Private Key',
    zhCN: '内联私钥',
    enUS: 'Inline Private Key',
    context: 'TLS settings',
  },
  {
    source: 'Generate Self-Signed Certificate',
    zhCN: '生成自签名证书',
    enUS: 'Generate Self-Signed Certificate',
    context: 'TLS settings',
  },
  {
    source: 'Self-signed certificate generated',
    zhCN: '自签名证书已生成',
    enUS: 'Self-signed certificate generated',
    context: 'TLS settings',
  },
  {
    source: 'Failed to generate certificate',
    zhCN: '生成证书失败',
    enUS: 'Failed to generate certificate',
    context: 'TLS settings',
  },
  {
    source: 'Initial Stream Window',
    zhCN: '初始流接收窗口',
    enUS: 'Initial Stream Window',
    context: 'Hysteria QUIC settings',
  },
  {
    source: 'Max Stream Window',
    zhCN: '最大流接收窗口',
    enUS: 'Max Stream Window',
    context: 'Hysteria QUIC settings',
  },
  {
    source: 'Initial Connection Window',
    zhCN: '初始连接接收窗口',
    enUS: 'Initial Connection Window',
    context: 'Hysteria QUIC settings',
  },
  {
    source: 'Max Connection Window',
    zhCN: '最大连接接收窗口',
    enUS: 'Max Connection Window',
    context: 'Hysteria QUIC settings',
  },
  {
    source: 'Max Idle Timeout',
    zhCN: '最大空闲超时',
    enUS: 'Max Idle Timeout',
    context: 'Hysteria QUIC settings',
  },
  {
    source: 'Max Incoming Streams',
    zhCN: '最大入站流数',
    enUS: 'Max Incoming Streams',
    context: 'Hysteria QUIC settings',
  },
  {
