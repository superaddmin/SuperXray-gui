...
export const legacyEndpoints = {
  ...
  xray: {
    setting: 'panel/api/xray/',
    update: 'panel/api/xray/update',
    result: 'panel/api/xray/getXrayResult',
    outboundsTraffic: 'panel/api/xray/getOutboundsTraffic',
    resetOutboundsTraffic: 'panel/api/xray/resetOutboundsTraffic',
    testOutbound: 'panel/api/xray/testOutbound',
    warp: (action: string) => `panel/api/xray/warp/${encodePath(action)}`,
    nord: (action: string) => `panel/api/xray/nord/${encodePath(action)}`,
  },
  settings: {
    all: 'panel/api/setting/all',
    defaultSettings: 'panel/api/setting/defaultSettings',
    update: 'panel/api/setting/update',
    updateUser: 'panel/api/setting/updateUser',
    restartPanel: 'panel/api/setting/restartPanel',
  },
} as const;
