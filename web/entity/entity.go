// Package entity defines data structures and entities used by the web layer of the SuperXray panel.
package entity
...
// AllSetting contains all configuration settings for the SuperXray panel including web server, Telegram bot, and subscription settings.
