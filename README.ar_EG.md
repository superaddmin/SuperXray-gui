...
تُنشر الحزم الرسمية حاليًا لنظام Linux بمعماريتي `amd64` و `arm64`. يعرض المثبّت في النهاية اسم المستخدم وكلمة المرور ومنفذ اللوحة و `webBasePath` التي تم إنشاؤها؛ احفظ هذه القيم. تتوفر صورة Docker على `ghcr.io/superaddmin/superxray-gui:3.4.2`. راجع [docs/deployment.md](docs/deployment.md) لتفاصيل Docker والنشر الثنائي ومتطلبات البيئة.
