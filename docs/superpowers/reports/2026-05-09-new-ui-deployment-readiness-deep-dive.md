...
> **状态更新（2026-05-15）**：本文的部署裁决基于 2026-05-09 当时的 release gate 与功能 parity 状态。后续版本已经发布到 `v3.0.11`，并修复/补齐 Inbounds 分享导出、订阅导出、二维码、JSON、Clone、Reset、Reality `target` 空值拦截和新 UI 订阅公开 URI 默认值补齐。本文仍可作为历史风险清单参考，但涉及 Inbounds 导出订阅和 Reality target 的阻断项不再代表当前最新状态。
